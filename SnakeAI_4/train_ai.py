...
def train_ai(
    ...
    print(f"  Архитектура: [8, 1024, 1536, 1024, 512, 4]")
    print("\nНачинаем обучение...\n")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--generations', type=int, default=100,
                       help='Количество поколений для обучения (по умолчанию: 100)')
    parser.add_argument('--population', type=int, default=200,
                       help='Размер популяции (по умолчанию: 200)')
    parser.add_argument('--width', type=int, default=30,
                       help='Ширина поля (по умолчанию: 30)')
    parser.add_argument('--height', type=int, default=30,
                       help='Высота поля (по умолчанию: 30)')
