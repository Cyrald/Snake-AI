...
class GeneticAlgorithm:
    ...
    def evaluate_fitness(self, ai_player: AIPlayer, max_steps: int = 1000) -> Tuple[float, int]:
        game = SnakeGame(self.field_width, self.field_height)
        steps = 0
        steps_without_food = 0
        max_steps_without_food = self.field_width * self.field_height * 2
    ...
    def save_best(self, filename: str = "best_ai.npy"):
        import numpy as np
