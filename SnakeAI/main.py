...
if __name__ == '__main__':
    ...
    if choice == 0:
        ...
        if os.path.exists('best_ai.npy'):
            print('Загружаем обученного ИИ из best_ai.npy...')
            try:
                weights = np.load('best_ai.npy')
            ...
            print('Файл best_ai.npy не найден')
            print('Используем случайного ИИ (обучите сначала через train_ai.py)')
